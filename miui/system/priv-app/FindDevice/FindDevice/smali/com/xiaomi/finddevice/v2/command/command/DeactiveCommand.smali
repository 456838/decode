.class public Lcom/xiaomi/finddevice/v2/command/command/DeactiveCommand;
.super Lcom/xiaomi/finddevice/v2/command/command/Command;
.source "DeactiveCommand.java"
...
.method protected onExecute()Lcom/xiaomi/finddevice/v2/command/command/Command$ExecutionStatus;
    ...
    .line 19
    invoke-static {}, Lcom/xiaomi/finddevice/v2/update/PeriodicUpdateTask;->doAll()V

    .line 22
    const/4 v1, 0x0

    :try_start_0
    invoke-virtual {p0, v1}, Lcom/xiaomi/finddevice/v2/command/command/DeactiveCommand;->reply(Ljava/lang/Object;)Lcom/xiaomi/finddevice/v2/command/command/Command$ReplyGate;
    :try_end_0
