...
.method private constructor <init>(Lcom/squareup/okhttp/internal/framed/FramedConnection$Builder;)V
    ...
    invoke-static {v1}, Lokio/h;->aIO(Ljava/net/Socket;)Lokio/m;
    ...
    invoke-interface {v0, v1, v2}, Lcom/squareup/okhttp/internal/framed/Variant;->newWriter(Lokio/u;Z)Lcom/squareup/okhttp/internal/framed/FrameWriter;
...
.method static synthetic access$1200(Lcom/squareup/okhttp/internal/framed/FramedConnection;ILokio/r;IZ)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/squareup/okhttp/internal/framed/FramedConnection;->pushDataLater(ILokio/r;IZ)V
...
.method private pushDataLater(ILokio/r;IZ)V
    .locals 9
    ...
    invoke-interface {p2, v0, v1}, Lokio/r;->aIX(J)V

    int-to-long v0, p3

    invoke-interface {p2, v5, v0, v1}, Lokio/r;->read(Lokio/i;J)J

    invoke-virtual {v5}, Lokio/i;->size()J
    ...
    invoke-direct/range {v0 .. v7}, Lcom/squareup/okhttp/internal/framed/FramedConnection$6;-><init>(Lcom/squareup/okhttp/internal/framed/FramedConnection;Ljava/lang/String;[Ljava/lang/Object;ILokio/i;IZ)V
...
.method private declared-synchronized removePing(I)Lcom/squareup/okhttp/internal/framed/Ping;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/squareup/okhttp/internal/framed/FramedConnection;->pings:Ljava/util/Map;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public ping()Lcom/squareup/okhttp/internal/framed/Ping;
    ...
    invoke-direct {p0, v4, v1, v2, v0}, Lcom/squareup/okhttp/internal/framed/FramedConnection;->writePing(ZIILcom/squareup/okhttp/internal/framed/Ping;)V
...
.method public pushStream(ILjava/util/List;Z)Lcom/squareup/okhttp/internal/framed/FramedStream;
    ...
    invoke-direct {p0, p1, p2, p3, v2}, Lcom/squareup/okhttp/internal/framed/FramedConnection;->newStream(ILjava/util/List;ZZ)Lcom/squareup/okhttp/internal/framed/FramedStream;
...
.method public writeData(IZLokio/i;J)V
    .locals 10
    ...
    invoke-interface {v0, p2, p1, p3, v2}, Lcom/squareup/okhttp/internal/framed/FrameWriter;->data(ZILokio/i;I)V
    ...
    :goto_0
    invoke-interface {v4, v0, p1, p3, v3}, Lcom/squareup/okhttp/internal/framed/FrameWriter;->data(ZILokio/i;I)V
