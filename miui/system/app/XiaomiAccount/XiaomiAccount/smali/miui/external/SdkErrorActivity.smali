...
# static fields
.field private static final synthetic asI:[I


# instance fields
.field private asG:Landroid/content/DialogInterface$OnClickListener;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lmiui/external/b;

    invoke-direct {v0, p0}, Lmiui/external/b;-><init>(Lmiui/external/SdkErrorActivity;)V

    iput-object v0, p0, Lmiui/external/SdkErrorActivity;->asG:Landroid/content/DialogInterface$OnClickListener;

    new-instance v0, Lmiui/external/d;

    invoke-direct {v0, p0}, Lmiui/external/d;-><init>(Lmiui/external/SdkErrorActivity;)V

    iput-object v0, p0, Lmiui/external/SdkErrorActivity;->asH:Landroid/content/DialogInterface$OnClickListener;

    return-void
.end method

.method static synthetic aGA(Lmiui/external/SdkErrorActivity;)Z
    .locals 1
...
.method private aGv(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
    .locals 2
...
.method private aGw(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
    .locals 2
...
.method static synthetic aGx(Lmiui/external/SdkErrorActivity;)Landroid/app/Dialog;
    .locals 1

    invoke-direct {p0}, Lmiui/external/SdkErrorActivity;->q()Landroid/app/Dialog;
...
.method static synthetic aGy(Lmiui/external/SdkErrorActivity;)Landroid/app/Dialog;
    .locals 1
...
.method static synthetic aGz(Lmiui/external/SdkErrorActivity;)Landroid/app/Dialog;
    .locals 1
...
.method private m()Landroid/app/Dialog;
    ...
    iget-object v1, p0, Lmiui/external/SdkErrorActivity;->h:Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Lmiui/external/SdkErrorActivity;->asG:Landroid/content/DialogInterface$OnClickListener;

    invoke-direct {p0, v1, v0, v2}, Lmiui/external/SdkErrorActivity;->aGw(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
...
.method private n()Landroid/app/Dialog;
    ...
    invoke-direct {p0}, Lmiui/external/SdkErrorActivity;->t()Z
    ...
    :goto_1
    iget-object v2, p0, Lmiui/external/SdkErrorActivity;->asH:Landroid/content/DialogInterface$OnClickListener;

    iget-object v3, p0, Lmiui/external/SdkErrorActivity;->asG:Landroid/content/DialogInterface$OnClickListener;

    invoke-direct {p0, v1, v0, v2, v3}, Lmiui/external/SdkErrorActivity;->aGv(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
...
.method private static synthetic z()[I
    ...
    sget-object v0, Lmiui/external/SdkErrorActivity;->asI:[I
    ...
    :goto_2
    sput-object v0, Lmiui/external/SdkErrorActivity;->asI:[I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lmiui/external/SdkErrorActivity;->h:Ljava/lang/String;
    ...
    :cond_1
    invoke-static {}, Lmiui/external/SdkErrorActivity;->z()[I
    ...
    invoke-direct {v1, p0, v0}, Lmiui/external/c;-><init>(Lmiui/external/SdkErrorActivity;Landroid/app/Dialog;)V
    ...
    invoke-virtual {v1, v0, v2}, Lmiui/external/c;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
